...
<body>
                ...
                <form method="POST" action="" id="editStudentForm">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="firstname" id="firstname" value="<?php echo htmlspecialchars($student['firstname'] ?? ''); ?>" required>
                        </div>

                        <div class="form-group">
                            <label>Middle Name</label>
                            <input type="text" name="middlename" id="middlename" maxlength="2" value="<?php echo htmlspecialchars($student['middlename'] ?? ''); ?>" placeholder="M.I.">
                        </div>
                    </div>

                    <div class="form-group">
                        <label>Last Name <span>*</span></label>
                        <input type="text" name="lastname" id="lastname" value="<?php echo htmlspecialchars($student['lastname'] ?? ''); ?>" required>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label>Birthdate <span>*</span></label>
                            <input type="date" name="birthdate" id="birthdate" value="<?php echo htmlspecialchars($student['birthdate'] ?? ''); ?>" required>
                            <div class="form-hint">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_number" id="id_number" value="<?php echo htmlspecialchars($student['id_number'] ?? ''); ?>" readonly disabled>
                        <div class="form-hint">
                    ...
                    <div class="preview-card">
                        ...
                        <div class="preview-item">
                            ...
                            <div class="preview-details">
                                <h5 id="previewName"><?php echo htmlspecialchars($student['fullname']); ?></h5>
    ...
    <script>
        ...
        const studentData = {
            ...
            initial: '<?php echo strtoupper(substr($student['fullname'], 0, 1)); ?>'
        };
    </script>
</body>
</html>